...
public class LoadingIosDialog extends Dialog {
    ...
    public LoadingIosDialog(Context context) {
        super(context);
    }

    public LoadingIosDialog(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public LoadingIosDialog create() {

            LayoutInflater inflater = LayoutInflater.from(context);
            View view = inflater.inflate(R.layout.ios_loading_dialog, null);
            LoadingIosDialog loadingDialog = new LoadingIosDialog(context, R.style.IosDialogStyle);
