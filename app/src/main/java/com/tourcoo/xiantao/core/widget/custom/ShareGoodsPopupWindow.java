...
public class ShareGoodsPopupWindow extends PopupWindow {
    ...
    public ShareGoodsPopupWindow(Context context, boolean isHideWXFriend) {
        super(context);
    ...
    public void setISharePopupWindowClickListener(SharePopupWindow.ISharePopupWindowClickListener listener) {
