package com.tourcoo.xiantao.widget.custom;
...
public class LabelLayout extends ViewGroup {
    ...
    // the spacing between lines in flowlayout
    ...
    public LabelLayout(Context context, int lineSpacing, int usefulWidth) {
    ...
    public LabelLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lineSpacing = mTypedArray.getDimensionPixelSize(
                R.styleable.LabelLayout_lineSpacing, 0);
        mTypedArray.recycle();
    }
