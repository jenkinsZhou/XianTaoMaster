...
import com.tourcoo.xiantao.widget.sku.widget.FlowLayout;
...
public class SkuItemLayout extends LinearLayout {
    ...
    public void buildItemLayout(int position, String attributeName, List<SkuAttribute> attributeValueList) {
        ...
        for (int i = 0; i < attributeValueList.size(); i++) {
            ...
            itemView.setAttributeId(attributeValueList.get(i).getItem_id());
            itemView.setAttributeValue(attributeValueList.get(i).getSpec_value());
    ...
    private void onSkuItemClicked(int position, SkuItemView view) {
        ...
        attribute.setItem_id(view.getAttributeId());
