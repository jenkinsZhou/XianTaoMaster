 ...
 */
public class GoodsCategorySaleFragment extends BaseRefreshFragment<GoodsCategoryBean.GoodsSimpleInfo> {
    ...
    public void loadData(int page) {
        ...
        getCategoryGoodsList(TYPE_GOODS_SALES, page);
    }
    ...
    public static GoodsCategorySaleFragment newInstance() {
        Bundle args = new Bundle();
        GoodsCategorySaleFragment fragment = new GoodsCategorySaleFragment();
