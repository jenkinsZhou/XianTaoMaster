package com.tourcoo.xiantao.ui.base;
...
import com.tourcoo.xiantao.util.FileUtil;
import com.tourcoo.xiantao.util.NotificationUtil;

import java.io.File;

import androidx.appcompat.app.AlertDialog;

import static com.tourcoo.xiantao.core.common.CommonConstant.SUFFIX_APK;
...
public class WebViewActivity extends BaseWebActivity {
    ...
    protected DownloadListenerAdapter mDownloadListenerAdapter = new DownloadListenerAdapter() {
        ...
        public boolean onResult(String path, String url, Throwable throwable) {
            ...
            return path.endsWith(SUFFIX_APK);
        }
    };
