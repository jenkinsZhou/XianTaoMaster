...
public abstract class BaseFragment extends RxFragment implements IBaseView {
    ...
    protected boolean isSingleFragment() {
        ...
        NaViLogUtil.i(TAG, TAG + ";FragmentManager承载Fragment数量:" + size);
        return size <= 1;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        NaViLogUtil.i(TAG, TAG + ";mIsVisibleChanged:" + mIsVisibleChanged
    ...
    public void onResume() {
        super.onResume();
        NaViLogUtil.i(TAG, "onResume-isAdded:" + isAdded() + ";getUserVisibleHint:" + getUserVisibleHint()
    ...
    protected void onVisibleChanged(final boolean isVisibleToUser) {
        NaViLogUtil.i(TAG, "onVisibleChanged-isVisibleToUser:" + isVisibleToUser);
