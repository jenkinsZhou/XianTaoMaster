...
import com.emi.navi.core.frame.widget.NaViLoadMoreView;
...
//                        return MyLoadMoreView();
    ...
    public void setRecyclerView(RecyclerView recyclerView, Class<?> cls) {
        NaViLogUtil.i(TAG, "setRecyclerView-" + cls.getSimpleName() + "context:" + recyclerView.getContext() + ";:" + (Activity.class.isAssignableFrom(recyclerView.getContext().getClass())) + ";:" + (recyclerView.getContext() instanceof Activity));
    }
...
//                .create());
    ...
    public boolean createTitleBarViewControl(TitleBarView titleBar, Class<?> cls) {
        ...
        Drawable mDrawable = NaViUtil.getTintDrawable(ContextCompat.getDrawable(mContext, R.drawable.ic_back),
