package com.emi.navi.core.util;
...
import static com.emi.navi.core.common.CommonConfig.TOAST_DURATION;
...
public class ToastUtil {
    ...
    public static void show(int content, boolean isShowRunningForeground, Builder builder) {
        if (null == sContext) {
            throw new NullPointerException(ExceptionConstant.EXCEPTION_NOT_INIT);
        }
    ...
    private static void showToast(CharSequence content, boolean isShowRunningForeground, Builder builder) {
        ...
        ToastControl control = UiConfigManager.getInstance().getToastControl();
        if (control != null) {
            control.setToast(sSystemToast, sTextView);
        }
        boolean showEnable = !isShowRunningForeground || (isShowRunningForeground && NaViUtil.isRunningForeground(sContext));
        if (showEnable) {
    ...
    public static Builder getSuccessBuilder() {
        if (sBuilderSuccess == null) {
            sBuilderSuccess = getDrawableBuilder(R.drawable.navi_ic_success);
        }
    ...
    public static Builder getFailedBuilder() {
        if (sBuilderFailed == null) {
            sBuilderFailed = getDrawableBuilder(R.drawable.navi_ic_failed);
        }
    ...
    public static Builder getWarningBuilder() {
        if (sBuilderWarning == null) {
            sBuilderWarning = getDrawableBuilder(R.drawable.navi_ic_warning);
        }
