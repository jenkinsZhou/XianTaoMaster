...
/**
 * @author :zhoujian
 * @description : 用于快速设置 BaseRecyclerViewAdapterHelper LoadMoreView相关布局属性
 * @company :翼迈科技
 * @date 2019年03月04日上午 10:28
 * @Email: 971613168@qq.com
 */
public class NaViLoadMoreView extends LoadMoreView {
    ...
    public NaViLoadMoreView(@Nullable Context context) {
        this(new Builder(context));
    }

    NaViLoadMoreView(Builder builder) {
    ...
    protected int getLoadingViewId() {
        return R.id.lLayout_loadingLoadMore;
    }
    ...
    public static final class Builder {
        ...
        public Builder(@Nullable Context context) {
            ...
            setLoadFailText(R.string.load_more_load_failed);
            setLoadEndText(R.string.load_more_load_end);
        }

        public Builder(NaViLoadMoreView loadMoreView) {
            this.mContext = loadMoreView.mContext;
            this.mLoadingSize = loadMoreView.mLoadingSize;
            this.mLoadingText = loadMoreView.mLoadingText;
            this.mLoadingTextColor = loadMoreView.mLoadingTextColor;
            this.mLoadingTextSize = loadMoreView.mLoadingTextSize;
            this.mLoadingProgressColor = loadMoreView.mLoadingProgressColor;
            this.mLoadingProgressDrawable = loadMoreView.mLoadingProgressDrawable;
            this.mLoadFailText = loadMoreView.mLoadFailText;
            this.mLoadFailTextColor = loadMoreView.mLoadFailTextColor;
            this.mLoadFailTextSize = loadMoreView.mLoadFailTextSize;
            this.mLoadEndText = loadMoreView.mLoadEndText;
            this.mLoadEndTextColor = loadMoreView.mLoadEndTextColor;
            this.mLoadEndTextSize = loadMoreView.mLoadEndTextSize;
        ...
        public NaViLoadMoreView build() {
            return new NaViLoadMoreView(this);
        }
    }
}
