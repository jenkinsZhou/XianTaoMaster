...
package com.emi.navi.core.crash;
...
import com.emi.navi.core.crash.imp.ISave;
...
public final class CrashManager {
    ...
    public static void init(Context context) {
        try {
            if (context == null) {
                NaViLogUtil.e("context为null");
            } else {
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                    NaViLogUtil.e("API版本过低");
                }
                //INSTALL!
                Thread.UncaughtExceptionHandler oldHandler = Thread.getDefaultUncaughtExceptionHandler();

                if (oldHandler != null && oldHandler.getClass().getName().startsWith(CAOC_HANDLER_PACKAGE_NAME)) {
                    NaViLogUtil.e("已经处理异常");
                } else {
                        ...
                        public void uncaughtException(Thread thread, final Throwable throwable) {
                            ...
                            if (isStackTraceLikelyConflictive(throwable, errorActivityClass)) {
                                ...
                                if (launchErrorActivityWhenInBackground || !isInBackground) {
                                    ...
                                    NaViLogUtil.e(TAG, "异常原因：" + stackTraceString);
