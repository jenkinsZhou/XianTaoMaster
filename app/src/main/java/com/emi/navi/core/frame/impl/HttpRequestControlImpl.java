...
import com.emi.navi.core.frame.interfaces.HttpRequestListener;
...
public class HttpRequestControlImpl implements HttpRequestControl {
    ...
    public void httpRequestSuccess(IRequestControl requestControl, List<?> list, HttpRequestListener listener) {
        ...
        NaViLogUtil.i(TAG, "smartRefreshLayout:" + smartRefreshLayout + ";adapter:" + adapter + ";status:" + ";page:" + page + ";class:" + requestControl.getRequestClass());
...
//        int code = FastError.EXCEPTION_OTHER_ERROR;
        if (!NetworkUtil.isConnected(NaViApplication.getContext())) {
