...
import com.emi.navi.widget.core.action.ActionSheetDialog;
...
public abstract class BaseWebActivity extends BaseTitleActivity {
    ...
    protected static void start(Activity mActivity, Class<? extends BaseWebActivity> activity, String url) {
        ...
        NaViUtil.startActivity(mActivity, activity, bundle);
    }
    ...
    public void beforeSetTitleBar(TitleBarView titleBar) {
        ...
        titleBar.setOnLeftTextClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                .setRightTextDrawable(NaViUtil.getTintDrawable(
                ...
                .addLeftAction(titleBar.new ImageAction(
                        NaViUtil.getTintDrawable(ContextCompat.getDrawable(mContext, R.drawable.ic_close),
                        ...
                        public void onClick(BaseDialog dialog, View itemView, int i) {
                            switch (i) {
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    NaViUtil.copyToClipboard(mContext, mCurrentUrl);
                                    ToastUtil.show("复制成功");
                                    break;
                                case 2:
                                    NaViUtil.startShareText(mContext, mCurrentUrl);
                                    break;
                                default:
                                    break;
                            }
