...
import static com.emi.navi.core.log.widget.config.LogConstant.TAG;
...
public class NaViUtil {
    ...
    public static CharSequence getAppName(Context context) {
        try {
            ...
            NaViLogUtil.e(TAG, "getAppName:" + e.getMessage());
        }
        return null;
    }
    ...
    public static String getVersionName(Context context) {
        try {
            ...
            NaViLogUtil.e("getVersionName:" + e.getMessage());
        }
        return "";
    }
    ...
    public static int getVersionCode(Context context) {
        try {
            ...
            NaViLogUtil.e("getVersionCode:" + e.getMessage());
        }
        return -1;
    }
    ...
    public static boolean isClassExist(String className) {
        ...
        try {
            ...
            NaViLogUtil.e("isClassExist:" + e.getMessage());
        }
        return isExit;
    }
    ...
    public static void jumpMarket(Context mContext, String packageName) {
        ...
        try {
            ...
            NaViLogUtil.e( "jumpMarket:" + e.getMessage());
        }
    }
