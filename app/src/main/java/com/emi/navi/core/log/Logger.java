package com.emi.navi.core.log;

import android.text.TextUtils;
import android.util.Log;

import com.emi.navi.core.log.widget.config.LogConfigImpl;
import com.emi.navi.core.log.widget.config.LogConstant;
import com.emi.navi.core.log.widget.config.LogLevel;
import com.emi.navi.core.log.widget.logfile.LogFileConfigImpl;
import com.emi.navi.core.log.widget.logfile.LogFileParam;
import com.emi.navi.core.log.widget.utils.Utils;
...
import static com.emi.navi.core.log.widget.config.LogLevel.TYPE_DEBUG;
import static com.emi.navi.core.log.widget.config.LogLevel.TYPE_ERROR;
import static com.emi.navi.core.log.widget.config.LogLevel.TYPE_INFO;
import static com.emi.navi.core.log.widget.config.LogLevel.TYPE_VERBOSE;
import static com.emi.navi.core.log.widget.config.LogLevel.TYPE_WARN;
import static com.emi.navi.core.log.widget.config.LogLevel.TYPE_WTF;
import static com.emi.navi.core.log.widget.utils.ObjectUtil.objectToString;
import static com.emi.navi.core.log.widget.utils.Utils.DIVIDER_BOTTOM;
import static com.emi.navi.core.log.widget.utils.Utils.DIVIDER_CENTER;
import static com.emi.navi.core.log.widget.utils.Utils.DIVIDER_NORMAL;
import static com.emi.navi.core.log.widget.utils.Utils.DIVIDER_TOP;
import static com.emi.navi.core.log.widget.utils.Utils.printDividingLine;
...
public final class Logger implements Printer {
    ...
    private StackTraceElement getCurrentStackTrace() {
        ...
        int stackOffset = getStackOffset(trace, NaViLogUtil.class);
        if (stackOffset == -1) {
