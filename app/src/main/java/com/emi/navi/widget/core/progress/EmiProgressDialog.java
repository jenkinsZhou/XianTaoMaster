package com.emi.navi.widget.core.progress;
...
/**
 * @author :zhoujian
 * @description : EmiProgressDialog
 * @company :翼迈科技
 * @date 2019年02月28日下午 05:00
 * @Email: 971613168@qq.com
 */

public class EmiProgressDialog extends BaseDialog<EmiProgressDialog> {
    ...
    private static abstract class Builder<T extends Builder> extends BasisBuilder<T> implements ICreateContentView {
        ...
        public EmiProgressDialog create() {
            int margin = dp2px(12);
            View contentView = createContentView();
            mDialog = new EmiProgressDialog(mContext);
            mDialog.setContentView(contentView);
            setDialog();
            mDialog.setGravity(Gravity.CENTER);
            mDialog.setMargin(margin, margin, margin, margin);
            afterSetContentView();
            return (EmiProgressDialog) mDialog;
        }
