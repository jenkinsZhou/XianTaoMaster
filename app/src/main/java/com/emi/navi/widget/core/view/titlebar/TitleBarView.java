package com.emi.navi.widget.core.view.titlebar;
...
import com.emi.navi.widget.core.util.ResourceUtil;
import com.emi.navi.widget.core.util.StatusBarUtil;
import com.emi.navi.widget.core.view.alpha.AlphaImageView;
import com.emi.navi.widget.core.view.alpha.AlphaTextView;
import com.emi.navi.widget.core.view.titlebar.util.ViewGroupUtils;

/**
 * @author :zhoujian
 * @description : 自定义标题栏-支持沉浸式
 * @company :翼迈科技
...
//                        | View.SYSTEM_UI_FLAG_LAYOUT_STABLE);
    ...
    public TitleBarView setOutPadding(int paddingValue) {
        ...
        boolean leftPadingEnable = TextUtils.isEmpty(mLeftText)
